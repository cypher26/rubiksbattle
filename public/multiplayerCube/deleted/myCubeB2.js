	...
	//renderer1 = new THREE.CanvasRenderer1();
	//renderer1.setPixelRatio( window.devicePixelRatio );
	//renderer1.setSize( 740, 540 );
	renderer1.setSize( document.getElementById("player2").offsetWidth-20, document.getElementById("player2").offsetHeight-10);
	...
	var material1 = new THREE.MeshBasicMaterial( {  transparent:true, opacity: 0.0  } );
	var m1 = new THREE.MeshBasicMaterial( { wireframeLinewidth:51,color: 0xFF00FF, } );
	limit1 = 0;
	degree1 = Math.PI/180;
	camera1.position.z=2;
	var ff1 = new THREE.PlaneGeometry( 1.7, 1.7);
...
//	ad -=2;
	...
	for (x =0;x<6;x++){
		...
		for (y = 0;y<(dimension1*dimension1);y++){
					switch (x){
						case 0:
						color1 = upSide1;
							//console.log("y = " + y + " dimension1-1 "  + (y%(dimension1-1)));
	...
	leftSide1 = new THREE.MeshBasicMaterial( {color: 0xFFFFFF, side: THREE.DoubleSide} ); //leftSide1
	frontSide1 = new THREE.MeshBasicMaterial( {color: 0xFF0033, side: THREE.DoubleSide} ); //leftSide1
	rightSide1 = new THREE.MeshBasicMaterial( {color:0xffff00, side: THREE.DoubleSide} ); //leftSide1
	backSide1 = new THREE.MeshBasicMaterial( {color: 0xff8000, side: THREE.DoubleSide} ); //leftSide1
	downSide1 = new THREE.MeshBasicMaterial( {color:0x00ff00, side: THREE.DoubleSide} ); //leftSide1
	upSide1 = new THREE.MeshBasicMaterial( {color:0x0000ff, side: THREE.DoubleSide} ); //leftSide1
								}
